...
//           console.log("Admin login successful", data.token);
//         } else {
...
const Login = () => {
  ...
  // Reset Forgot Password related states
  ...
  const switchLoginMode = (mode) => {
    setState(mode);
    resetForgotPasswordStates(); // Reset the forgot password state when switching login modes
  };
